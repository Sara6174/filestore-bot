...
- `DB_CHANNEL` - A Telegram Channel ID.
	- Make a Channel for Storing Files. We will use that as Database. Channel must be Private! Else you will be Copyright by [Telegram DMCA](https://t.me/SSALink)!
...
### Credits:
* **Abir Hasan:** [Abir Hasan](https:/github.com/Sara6174)
* **Pyrogrammers:** [Pyrogrammers](https:/github.com/Sara6174)
